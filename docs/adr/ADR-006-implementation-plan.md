...
- The next cleanup target is the final `Component.route(...)` audit: identify exactly which remaining render/setup behaviors still require routed-component semantics and whether they can be lifted onto unified route values directly.
